...
const projects = [
    ...
    { id: "08", featured: false, title: "DermaDiff", subtitle: "AI Skin Analysis", desc: "AI-powered skin condition analysis tool leveraging diffusion models for dermatological assessment and diagnosis support.", category: "AI / ML" as Cat, tags: ["Diffusion Model", "PyTorch", "Computer Vision"], year: "2026", views: "0", image: "" },
];
        ...
        <main style={{ backgroundColor: "#0f0f0f", color: "#ededed", minHeight: "100vh" }}>
            ...
            <section className="px-8 md:px-16 lg:px-24 py-14" style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                <div className="flex flex-col divide-y" style={{ borderColor: "rgba(255,255,255,0.06)" }}>
                    {rest.map(p => (
                        <article key={p.id} onClick={() => setSelected(p)} className="py-8 flex items-start justify-between gap-6 group cursor-pointer">
                ...
                {selected && (
                    ...
                    >
                        ...
                        >
                            {/* Image */}
                            {selected.image ? (
                                <div className="w-full h-48 md:h-56 overflow-hidden" style={{ borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                                    <img src={selected.image} alt={selected.title} className="w-full h-full object-cover" />
                                </div>
                            ) : (
                                <div className="w-full h-48 md:h-56 flex items-center justify-center" style={{ backgroundColor: "rgba(255,255,255,0.03)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                            ...
                            <div className="p-6 md:p-8">
                                ...
                                <div className="flex flex-wrap gap-2 mb-6">
                                    {selected.tags.map(t => (
                                        <span key={t} className="px-2.5 py-1 rounded-md text-[11px]"
                                            style={{ ...gm, backgroundColor: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.07)", color: "rgba(255,255,255,0.35)" }}>
                                            {t}
                                        </span>
                                    ))}
                                </div>
